...
const NavBar = () => {
  return (
    <Box as="nav" bg="#004A6C" color="white" p={4} display={"flex"} alignItems="center" justifyContent="space-between">
      <svg id="logo" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="60px" height="31px" viewBox="0 0 60 31" xml:space="preserve" fillversion="1.1" fill="currentColor" class="w-[105px] h-[54px]"><polygon class="st0" points="18.7,0.7 0.4,0.7 0.4,8.5 7.1,8.5 0.4,15.5 0.4,30.4 18.7,30.4 18.7,22.6 5,22.6 18.7,8.1 "></polygon><path class="st0" d="M36.1,15.5L36.1,15.5L36.1,15.5c2.5-1.4,3.3-4.1,3.3-6.5c0-4.2-3.2-8.4-9.4-8.4h-8.8v7.8h5.5h0.9H29
